...
.spec-box {{ border:1px solid var(--line); border-radius:18px; padding:16px; background:#0b0b10; min-height:260px; color:#f8fafc; font-size:17px; line-height:1.42; }}
.spec-box b {{ color:var(--orange); }}
.spec-box div {{ margin-top:8px; padding:6px 10px; border-radius:10px; background:rgba(255,255,255,.035); }}
    ...
    section.innerHTML = `<div class="content">
      ...
      <div class="body two">
        ...
        <div class="card glow-card">
          ...
          <h2 style="margin-top:10px">${{r.product_name}}</h2>
          <div class="metric-strip" style="grid-template-columns:.8fr 1.2fr;margin-top:24px">
          ...
          <div style="margin-top:18px">
            ...
            <div class="spec-box editable-copy" style="margin-top:10px">
              <b>Nhập thông số sản phẩm tại đây</b>
              <div>- Màu sắc:</div>
